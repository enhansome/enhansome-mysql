...
* [Sysbench](https://github.com/akopytov/sysbench) ⭐ 6,799 | 🐛 217 | 🌐 C | 📅 2025-03-09 - a modular, cross-platform and multi-threaded benchmark tool.
* [HammerDB](https://github.com/TPC-Council/HammerDB) ⭐ 789 | 🐛 16 | 🌐 Tcl | 📅 2026-09-25 - An open-source database benchmark for MySQL/MariaDB and other open source and commercial databases.
...
* [node-mysql](https://github.com/mysqljs/mysql) ⭐ 18,620 | 🐛 176 | 🌐 JavaScript | 📅 2024-06-25 - A pure Nodejs Javascript client implementing the MySQL protocol.
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,285 | 🐛 60 | 🌐 Go | 📅 2026-09-19 - a lightweight and fast MySQL-Driver for Go's (golang) database/sql package.
...
* [cover\_me](https://github.com/verizonconnect/cover_me) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - code coverage tool for mysql stored procedures and functions
