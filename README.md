...
A curated list of awesome MySQL free and opensource software, libraries and resources. [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,015 | 🐛 105 | 📅 2026-08-21
...
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 65,880 | 🐛 880 | 🌐 Go | 📅 2026-08-29/[mysqld\_exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,462 | 🐛 181 | 🌐 Go | 📅 2026-08-18 - Time series database for real-time monitoring and alerting.
...
* [Databasus](https://github.com/databasus/databasus) ⭐ 8,362 | 🐛 3 | 🌐 Go | 📅 2026-08-29 - tool for scheduled MySQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
...
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,271 | 🐛 73 | 🌐 Go | 📅 2026-08-27 - a lightweight and fast MySQL-Driver for Go's (golang) database/sql package.
...
* [Flywaydb](https://github.com/flyway/flyway) ⭐ 10,042 | 🐛 255 | 🌐 Java | 📅 2026-08-26 - Database migrations; Evolve your database schema easily and reliably across all your instances
...
* [DBeaver](https://github.com/dbeaver/dbeaver/) ⭐ 51,581 | 🐛 3,366 | 🌐 Java | 📅 2026-08-29 - A cross-platform SQL and NoSQL database client.
...
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,970 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,918 | 🐛 946 | 🌐 PHP | 📅 2026-08-29 - a free software tool written in PHP, intended to handle the administration of MySQL over the Web.
* [Adminer](https://github.com/vrana/adminer/) ⭐ 7,838 | 🐛 7 | 🌐 PHP | 📅 2026-08-17 - Database management in a single PHP file.
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,523 | 🐛 174 | 🌐 Objective-C | 📅 2026-08-25 - a Mac database management application for working with MySQL databases.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 6,231 | 🐛 317 | 🌐 Pascal | 📅 2026-08-27 - MySQL GUI frontend for Windows.
* [TablePro](https://github.com/TableProApp/TablePro) ⭐ 5,576 | 🐛 85 | 🌐 Swift | 📅 2026-08-29 - Native macOS client for MySQL and many other databases with inline editing, SSH tunneling, and AI assistant. Free and open-source.
...
* [MySQL Workbench](https://github.com/mysql/mysql-workbench) ⭐ 996 | 🐛 3 | 🌐 C++ | 📅 2026-04-23 - provides DBAs and developers an integrated tools environment for database design & modeling; SQL devleopment; database administration.
* [StackRender](https://github.com/stackrender/stackrender) ⭐ 531 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-05 - Free and open-source database schema design and SQL migration generator for MySQL.
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 371 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-28 - Browser-based SQL IDE for MySQL and nine other engines, deployed as a container or Helm chart next to the database.
...
* [ProxySQL](https://github.com/sysown/proxysql) ⭐ 6,905 | 🐛 1,096 | 🌐 C++ | 📅 2026-08-28 - High performance proxy for MySQL.
...
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,152 | 🐛 476 | 🌐 C++ | 📅 2026-08-29 - Community developed fork of MySQL server.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 21,274 | 🐛 1,093 | 🌐 Go | 📅 2026-08-29 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [gh-ost](https://github.com/github/gh-ost/) ⭐ 13,545 | 🐛 328 | 🌐 Go | 📅 2026-08-28 - GitHub's online schema migration for MySQL.
- [go-mysql](https://github.com/go-mysql-org/go-mysql) ⭐ 4,963 | 🐛 157 | 🌐 Go | 📅 2026-08-23 - A pure go library to handle MySQL network protocol and replication.
...
* [VillageSQL](https://github.com/villagesql/villagesql-server) ⭐ 174 | 🐛 261 | 🌐 C++ | 📅 2026-08-29 - A drop-in replacement for MySQL with extensions for the agentic AI era.
