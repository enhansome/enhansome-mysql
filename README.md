...
A curated list of awesome MySQL free and opensource software, libraries and resources. [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,463 | 🐛 105 | 📅 2026-08-21

This list accepts and encourages pull requests. See [CONTRIBUTING](https://github.com/shlomi-noach/awesome-mysql/blob/master/CONTRIBUTING.md) ⭐ 2,611 | 🐛 17 | 🌐 Python | 📅 2026-08-17
...
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 65,857 | 🐛 888 | 🌐 Go | 📅 2026-08-27/[mysqld\_exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,462 | 🐛 181 | 🌐 Go | 📅 2026-08-18 - Time series database for real-time monitoring and alerting.
* [MySQLTuner-perl](https://github.com/major/MySQLTuner-perl) ⭐ 9,474 | 🐛 7 | 🌐 Perl | 📅 2026-08-24 - A script that allows you to review a MySQL installation quickly and make adjustments to increase performance and stability.
...
* [Dolphie](https://github.com/charles-001/dolphie) ⭐ 1,194 | 🐛 1 | 🌐 Python | 📅 2026-08-24 - a modern terminal tool for real-time analytics into MySQL/MariaDB & ProxySQL
...
* [Dumpling](https://github.com/pingcap/tidb/tree/master/dumpling) ⭐ 40,475 | 🐛 6,841 | 🌐 Go | 📅 2026-08-27 - Logical, parallel backup/dumper tool for MySQL/TiDB written in GoLang - support csv format output and integrated as library
* [Databasus](https://github.com/databasus/databasus) ⭐ 8,321 | 🐛 7 | 🌐 Go | 📅 2026-08-26 - tool for scheduled MySQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [MyDumper](https://github.com/mydumper/mydumper) ⭐ 3,217 | 🐛 62 | 🌐 C | 📅 2026-08-26 - Logical, parallel backup/dumper tool for MySQL
* [Portabase](https://github.com/Portabase/portabase) ⭐ 1,664 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-27 - Agent-based platform for MySQL backups and restores with decentralized execution and centralized orchestration.
* [Percona Xtrabackup](https://github.com/percona/percona-xtrabackup) ⭐ 1,549 | 🐛 22 | 🌐 C++ | 📅 2026-08-24 - an open-source hot backup utility for MySQL - based servers that doesn’t lock your database during the backup.

## Benchmarking

*Tools to stress your servers*

* [Sysbench](https://github.com/akopytov/sysbench) ⭐ 6,782 | 🐛 217 | 🌐 C | 📅 2025-03-09 - a modular, cross-platform and multi-threaded benchmark tool.
* [HammerDB](https://github.com/TPC-Council/HammerDB) ⭐ 779 | 🐛 15 | 🌐 Tcl | 📅 2026-08-25 - An open-source database benchmark for MySQL/MariaDB and other open source and commercial databases.
...
* [DM](https://github.com/pingcap/tiflow) ⭐ 464 | 🐛 970 | 🌐 Go | 📅 2026-08-27 - A High-Availability data migration platform which supports migrating data from MySQL/MariaDB to TiDB and merging shard tables
...
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,273 | 🐛 73 | 🌐 Go | 📅 2026-08-27 - a lightweight and fast MySQL-Driver for Go's (golang) database/sql package.
* [PyMySQL](https://github.com/PyMySQL/PyMySQL) ⭐ 7,845 | 🐛 15 | 🌐 Python | 📅 2026-08-18 - MySQL database connector for Python.
...
* [MariaDB Connector/J](https://github.com/mariadb-corporation/mariadb-connector-j) ⭐ 360 | 🐛 4 | 🌐 Java | 📅 2026-07-29 - LGPL-licensed MariaDB Client Library for Java Applications.
...
* [MariaDB4j](https://github.com/MariaDB4j/MariaDB4j) ⭐ 899 | 🐛 17 | 🌐 Java | 📅 2026-07-14 - A Java launcher to run MariaDB without installation or external dependencies.

## Development

*Tools to support MySQL-related development*

* [Flywaydb](https://github.com/flyway/flyway) ⭐ 10,033 | 🐛 255 | 🌐 Java | 📅 2026-08-26 - Database migrations; Evolve your database schema easily and reliably across all your instances
* [Liquibase](https://github.com/liquibase/liquibase) ⭐ 5,596 | 🐛 250 | 🌐 Java | 📅 2026-08-27 - Source control for your database
* [Test database](https://github.com/datacharmer/test_db) ⭐ 4,434 | 🐛 2 | 🌐 PLpgSQL | 📅 2026-04-10 - A sample MySQL database with an integrated test suite, used to test applications and servers
* [SQLE](https://github.com/actiontech/sqle/blob/main/README_en.md) ⭐ 1,499 | 🐛 197 | 🌐 Go | 📅 2026-08-26 - SQLE is a SQL audit platform for DBA or developer
* [Skeema](https://github.com/skeema/skeema) ⭐ 1,377 | 🐛 15 | 🌐 Go | 📅 2026-08-26 - Declarative pure-SQL schema management system for MySQL and MariaDB, with support for sharding and external online schema change tools
...
* [DBeaver](https://github.com/dbeaver/dbeaver/) ⭐ 51,568 | 🐛 3,358 | 🌐 Java | 📅 2026-08-27 - A cross-platform SQL and NoSQL database client.
* [ILLA Cloud](https://github.com/illacloud/illa-builder) ⭐ 12,312 | 🐛 43 | 🌐 TypeScript | 📅 2026-05-27 - Low-code internal tool builder integrated with Mysql, can be used as GUI for Mysql.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,915 | 🐛 948 | 🌐 PHP | 📅 2026-08-27 - a free software tool written in PHP, intended to handle the administration of MySQL over the Web.
* [Adminer](https://github.com/vrana/adminer/) ⭐ 7,833 | 🐛 5 | 🌐 PHP | 📅 2026-08-17 - Database management in a single PHP file.
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,516 | 🐛 174 | 🌐 Objective-C | 📅 2026-08-25 - a Mac database management application for working with MySQL databases.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 6,226 | 🐛 317 | 🌐 Pascal | 📅 2026-08-27 - MySQL GUI frontend for Windows.
* [TablePro](https://github.com/TableProApp/TablePro) ⭐ 5,566 | 🐛 86 | 🌐 Swift | 📅 2026-08-27 - Native macOS client for MySQL and many other databases with inline editing, SSH tunneling, and AI assistant. Free and open-source.
* [OmniDB: Web tool for database management](https://github.com/OmniDB/OmniDB) ⭐ 3,284 | 🐛 330 | 🌐 JavaScript | 📅 2023-02-01
* [pspg](https://github.com/okbob/pspg) ⭐ 2,730 | 🐛 0 | 🌐 C | 📅 2026-06-28 - provides a pager with enhanced visualization and navigation for tabular data. Originally implemented for PostgreSQL, but also supports MySQL.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 1,093 | 🐛 218 | 🌐 Go | 📅 2026-08-27 - An open-source platform for managing and monitoring MySQL performance.
...
* [StackRender](https://github.com/stackrender/stackrender) ⭐ 531 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-05 - Free and open-source database schema design and SQL migration generator for MySQL.
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 356 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-27 - Browser-based SQL IDE for MySQL and nine other engines, deployed as a container or Helm chart next to the database.
...
* [squix](https://github.com/eduardofuncao/squix) ⭐ 267 | 🐛 11 | 🌐 Go | 📅 2026-08-27 - SQL command-line client with query management and interactive results.
...
* [replication-manager](https://github.com/signal18/replication-manager) ⭐ 739 | 🐛 171 | 🌐 Go | 📅 2026-08-27 - a high availability solution to manage MariaDB 10.x and MySQL & Percona Server 5.7 GTID replication topologies.
...
* [MCP MariaDB Server](https://github.com/MariaDB/mcp) ⭐ 196 | 🐛 27 | 🌐 Python | 📅 2026-08-10 - the official MariaDB MCP server.
...
* [ProxySQL](https://github.com/sysown/proxysql) ⭐ 6,902 | 🐛 1,094 | 🌐 C++ | 📅 2026-08-27 - High performance proxy for MySQL.
...
* [TiDB](https://github.com/pingcap/tidb) ⭐ 40,475 | 🐛 6,841 | 🌐 Go | 📅 2026-08-27 - A distributed HTAP database compatible with the MySQL protocol.
* [MySQL Server & MySQL Cluster](https://github.com/mysql/mysql-server) ⭐ 12,407 | 🐛 42 | 🌐 C++ | 📅 2026-08-27 - Official Oracle's MySQL server & MySQL Cluster distribution.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,149 | 🐛 474 | 🌐 C++ | 📅 2026-08-27 - Community developed fork of MySQL server.
* [Percona Server](https://github.com/percona/percona-server) ⭐ 1,271 | 🐛 93 | 🌐 C++ | 📅 2026-08-27 - An enhanced, drop-in MySQL replacement.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 21,265 | 🐛 1,099 | 🌐 Go | 📅 2026-08-27 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [gh-ost](https://github.com/github/gh-ost/) ⭐ 13,543 | 🐛 328 | 🌐 Go | 📅 2026-08-26 - GitHub's online schema migration for MySQL.
...
- [Percona Toolkit](https://github.com/percona/percona-toolkit) ⭐ 1,544 | 🐛 36 | 🌐 Perl | 📅 2026-08-24 - a collection of advanced command-line tools to perform a variety of MySQL server and system tasks that are too difficult or complex to perform manually.
...
* [VillageSQL](https://github.com/villagesql/villagesql-server) ⭐ 174 | 🐛 259 | 🌐 C++ | 📅 2026-08-27 - A drop-in replacement for MySQL with extensions for the agentic AI era.
