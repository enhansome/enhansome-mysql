...
A curated list of awesome MySQL free and opensource software, libraries and resources. [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,466 | 🐛 106 | 📅 2026-09-02
...
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 65,962 | 🐛 896 | 🌐 Go | 📅 2026-09-04/[mysqld\_exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,461 | 🐛 172 | 🌐 Go | 📅 2026-09-04 - Time series database for real-time monitoring and alerting.
* [MySQLTuner-perl](https://github.com/major/MySQLTuner-perl) ⭐ 9,477 | 🐛 7 | 🌐 Perl | 📅 2026-08-31 - A script that allows you to review a MySQL installation quickly and make adjustments to increase performance and stability.
...
* [Dumpling](https://github.com/pingcap/tidb/tree/master/dumpling) ⭐ 40,490 | 🐛 6,934 | 🌐 Go | 📅 2026-09-06 - Logical, parallel backup/dumper tool for MySQL/TiDB written in GoLang - support csv format output and integrated as library
* [Databasus](https://github.com/databasus/databasus) ⭐ 8,430 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-05 - tool for scheduled MySQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [MyDumper](https://github.com/mydumper/mydumper) ⭐ 3,222 | 🐛 56 | 🌐 C | 📅 2026-09-02 - Logical, parallel backup/dumper tool for MySQL
* [Portabase](https://github.com/Portabase/portabase) ⭐ 1,683 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-05 - Agent-based platform for MySQL backups and restores with decentralized execution and centralized orchestration.
* [Percona Xtrabackup](https://github.com/percona/percona-xtrabackup) ⭐ 1,551 | 🐛 23 | 🌐 C++ | 📅 2026-09-04 - an open-source hot backup utility for MySQL - based servers that doesn’t lock your database during the backup.
...
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,280 | 🐛 59 | 🌐 Go | 📅 2026-09-05 - a lightweight and fast MySQL-Driver for Go's (golang) database/sql package.
* [PyMySQL](https://github.com/PyMySQL/PyMySQL) ⭐ 7,844 | 🐛 16 | 🌐 Python | 📅 2026-08-18 - MySQL database connector for Python.
* [mysqlclient-python](https://github.com/PyMySQL/mysqlclient) ⭐ 2,537 | 🐛 4 | 🌐 Python | 📅 2026-09-06 - MySQL database connector for Python.
...
* [Flywaydb](https://github.com/flyway/flyway) ⭐ 10,068 | 🐛 254 | 🌐 Java | 📅 2026-09-03 - Database migrations; Evolve your database schema easily and reliably across all your instances
* [Liquibase](https://github.com/liquibase/liquibase) ⭐ 5,605 | 🐛 254 | 🌐 Java | 📅 2026-09-06 - Source control for your database
...
* [Skeema](https://github.com/skeema/skeema) ⭐ 1,380 | 🐛 15 | 🌐 Go | 📅 2026-09-05 - Declarative pure-SQL schema management system for MySQL and MariaDB, with support for sharding and external online schema change tools
...
* [DBeaver](https://github.com/dbeaver/dbeaver/) ⭐ 51,675 | 🐛 3,365 | 🌐 Java | 📅 2026-09-06 - A cross-platform SQL and NoSQL database client.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,929 | 🐛 935 | 🌐 PHP | 📅 2026-09-06 - a free software tool written in PHP, intended to handle the administration of MySQL over the Web.
* [Adminer](https://github.com/vrana/adminer/) ⭐ 7,859 | 🐛 1 | 🌐 PHP | 📅 2026-09-06 - Database management in a single PHP file.
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,527 | 🐛 184 | 🌐 Objective-C | 📅 2026-09-04 - a Mac database management application for working with MySQL databases.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 6,234 | 🐛 322 | 🌐 Pascal | 📅 2026-08-27 - MySQL GUI frontend for Windows.
* [TablePro](https://github.com/TableProApp/TablePro) ⭐ 5,791 | 🐛 68 | 🌐 Swift | 📅 2026-09-06 - Native macOS client for MySQL and many other databases with inline editing, SSH tunneling, and AI assistant. Free and open-source.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 1,096 | 🐛 218 | 🌐 Go | 📅 2026-09-05 - An open-source platform for managing and monitoring MySQL performance.
...
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 410 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-06 - Browser-based SQL IDE for MySQL and nine other engines, deployed as a container or Helm chart next to the database.
...
* [replication-manager](https://github.com/signal18/replication-manager) ⭐ 739 | 🐛 178 | 🌐 Go | 📅 2026-09-06 - a high availability solution to manage MariaDB 10.x and MySQL & Percona Server 5.7 GTID replication topologies.
...
* [ProxySQL](https://github.com/sysown/proxysql) ⭐ 6,912 | 🐛 1,073 | 🌐 C++ | 📅 2026-09-06 - High performance proxy for MySQL.
...
* [TiDB](https://github.com/pingcap/tidb) ⭐ 40,490 | 🐛 6,934 | 🌐 Go | 📅 2026-09-06 - A distributed HTAP database compatible with the MySQL protocol.
* [MySQL Server & MySQL Cluster](https://github.com/mysql/mysql-server) ⭐ 12,418 | 🐛 44 | 🌐 C++ | 📅 2026-09-02 - Official Oracle's MySQL server & MySQL Cluster distribution.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,184 | 🐛 478 | 🌐 C++ | 📅 2026-09-06 - Community developed fork of MySQL server.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 21,296 | 🐛 1,099 | 🌐 Go | 📅 2026-09-06 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [gh-ost](https://github.com/github/gh-ost/) ⭐ 13,557 | 🐛 329 | 🌐 Go | 📅 2026-09-04 - GitHub's online schema migration for MySQL.
...
- [Percona Toolkit](https://github.com/percona/percona-toolkit) ⭐ 1,548 | 🐛 24 | 🌐 Perl | 📅 2026-09-02 - a collection of advanced command-line tools to perform a variety of MySQL server and system tasks that are too difficult or complex to perform manually.
...
* [VillageSQL](https://github.com/villagesql/villagesql-server) ⭐ 179 | 🐛 274 | 🌐 C++ | 📅 2026-09-06 - A drop-in replacement for MySQL with extensions for the agentic AI era.
