...
A curated list of awesome MySQL free and opensource software, libraries and resources. [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,148 | 🐛 100 | 📅 2026-06-30
...
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 65,725 | 🐛 884 | 🌐 Go | 📅 2026-08-13/[mysqld\_exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,461 | 🐛 194 | 🌐 Go | 📅 2026-08-12 - Time series database for real-time monitoring and alerting.
...
* [Dumpling](https://github.com/pingcap/tidb/tree/master/dumpling) ⭐ 40,424 | 🐛 6,788 | 🌐 Go | 📅 2026-08-13 - Logical, parallel backup/dumper tool for MySQL/TiDB written in GoLang - support csv format output and integrated as library
* [Databasus](https://github.com/databasus/databasus) ⭐ 7,906 | 🐛 2 | 🌐 Go | 📅 2026-08-12 - tool for scheduled MySQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
...
* [HammerDB](https://github.com/TPC-Council/HammerDB) ⭐ 776 | 🐛 18 | 🌐 Tcl | 📅 2026-08-04 - An open-source database benchmark for MySQL/MariaDB and other open source and commercial databases.
...
* [DM](https://github.com/pingcap/tiflow) ⭐ 462 | 🐛 970 | 🌐 Go | 📅 2026-08-13 - A High-Availability data migration platform which supports migrating data from MySQL/MariaDB to TiDB and merging shard tables
...
* [node-mysql](https://github.com/mysqljs/mysql) ⭐ 18,623 | 🐛 175 | 🌐 JavaScript | 📅 2024-06-25 - A pure Nodejs Javascript client implementing the MySQL protocol.
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,277 | 🐛 72 | 🌐 Go | 📅 2026-08-07 - a lightweight and fast MySQL-Driver for Go's (golang) database/sql package.
...
* [Ruby Mysql2 gem](https://github.com/brianmario/mysql2) ⭐ 2,278 | 🐛 125 | 🌐 Ruby | 📅 2026-08-13 - MySQL driver for Ruby and Rails projects.
...
* [Flywaydb](https://github.com/flyway/flyway) ⭐ 9,990 | 🐛 250 | 🌐 Java | 📅 2026-08-06 - Database migrations; Evolve your database schema easily and reliably across all your instances
* [Liquibase](https://github.com/liquibase/liquibase) ⭐ 5,584 | 🐛 246 | 🌐 Java | 📅 2026-08-13 - Source control for your database
...
* [DBeaver](https://github.com/dbeaver/dbeaver/) ⭐ 51,440 | 🐛 3,315 | 🌐 Java | 📅 2026-08-13 - A cross-platform SQL and NoSQL database client.
...
* [Adminer](https://github.com/vrana/adminer/) ⭐ 7,748 | 🐛 2 | 🌐 PHP | 📅 2026-08-12 - Database management in a single PHP file.
...
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 6,208 | 🐛 314 | 🌐 Pascal | 📅 2026-08-07 - MySQL GUI frontend for Windows.
* [TablePro](https://github.com/TableProApp/TablePro) ⭐ 5,453 | 🐛 31 | 🌐 Swift | 📅 2026-08-13 - Native macOS client for MySQL and many other databases with inline editing, SSH tunneling, and AI assistant. Free and open-source.
...
* [replication-manager](https://github.com/signal18/replication-manager) ⭐ 737 | 🐛 176 | 🌐 Go | 📅 2026-08-13 - a high availability solution to manage MariaDB 10.x and MySQL & Percona Server 5.7 GTID replication topologies.
...
* [mha4mysql-node](https://github.com/yoshinorim/mha4mysql-node) ⭐ 410 | 🐛 14 | 🌐 Perl | 📅 2020-03-12 and [mha4mysql-manager](https://github.com/yoshinorim/mha4mysql-manager) ⭐ 1,508 | 🐛 73 | 🌐 Perl | 📅 2020-08-14 (both unmaintained) - Master High Availability Manager and tools for MySQL.
...
* [ProxySQL](https://github.com/sysown/proxysql) ⭐ 6,891 | 🐛 1,078 | 🌐 C++ | 📅 2026-08-13 - High performance proxy for MySQL.
...
* [TiDB](https://github.com/pingcap/tidb) ⭐ 40,424 | 🐛 6,788 | 🌐 Go | 📅 2026-08-13 - A distributed HTAP database compatible with the MySQL protocol.
* [MySQL Server & MySQL Cluster](https://github.com/mysql/mysql-server) ⭐ 12,380 | 🐛 32 | 🌐 C++ | 📅 2026-07-31 - Official Oracle's MySQL server & MySQL Cluster distribution.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,090 | 🐛 455 | 🌐 C++ | 📅 2026-08-13 - Community developed fork of MySQL server.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 21,219 | 🐛 1,069 | 🌐 Go | 📅 2026-08-12 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [gh-ost](https://github.com/github/gh-ost/) ⭐ 13,517 | 🐛 322 | 🌐 Go | 📅 2026-08-12 - GitHub's online schema migration for MySQL.
* [go-mysql](https://github.com/go-mysql-org/go-mysql) ⭐ 4,965 | 🐛 156 | 🌐 Go | 📅 2026-08-07 - A pure go library to handle MySQL network protocol and replication.
* [Percona Toolkit](https://github.com/percona/percona-toolkit) ⭐ 1,537 | 🐛 36 | 🌐 Perl | 📅 2026-08-13 - a collection of advanced command-line tools to perform a variety of MySQL server and system tasks that are too difficult or complex to perform manually.
