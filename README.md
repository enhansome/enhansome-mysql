...
A curated list of awesome MySQL free and opensource software, libraries and resources. [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,148 | 🐛 106 | 📅 2026-09-02
...
* [Prometheus](https://github.com/prometheus/prometheus) ⭐ 65,951 | 🐛 895 | 🌐 Go | 📅 2026-09-04/[mysqld\_exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,461 | 🐛 172 | 🌐 Go | 📅 2026-09-04 - Time series database for real-time monitoring and alerting.
...
* [Dumpling](https://github.com/pingcap/tidb/tree/master/dumpling) ⭐ 40,490 | 🐛 6,931 | 🌐 Go | 📅 2026-09-05 - Logical, parallel backup/dumper tool for MySQL/TiDB written in GoLang - support csv format output and integrated as library
* [Databasus](https://github.com/databasus/databasus) ⭐ 8,427 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-05 - tool for scheduled MySQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
...
* [Sysbench](https://github.com/akopytov/sysbench) ⭐ 6,785 | 🐛 217 | 🌐 C | 📅 2025-03-09 - a modular, cross-platform and multi-threaded benchmark tool.
...
* [go-sql-driver](https://github.com/go-sql-driver/mysql) ⭐ 15,277 | 🐛 60 | 🌐 Go | 📅 2026-09-04 - a lightweight and fast MySQL-Driver for Go's (golang) database/sql package.
...
* [Flywaydb](https://github.com/flyway/flyway) ⭐ 10,065 | 🐛 254 | 🌐 Java | 📅 2026-09-03 - Database migrations; Evolve your database schema easily and reliably across all your instances
* [Liquibase](https://github.com/liquibase/liquibase) ⭐ 5,605 | 🐛 254 | 🌐 Java | 📅 2026-09-04 - Source control for your database
...
* [DBeaver](https://github.com/dbeaver/dbeaver/) ⭐ 51,667 | 🐛 3,360 | 🌐 Java | 📅 2026-09-05 - A cross-platform SQL and NoSQL database client.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,928 | 🐛 939 | 🌐 PHP | 📅 2026-09-03 - a free software tool written in PHP, intended to handle the administration of MySQL over the Web.
...
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 6,235 | 🐛 320 | 🌐 Pascal | 📅 2026-08-27 - MySQL GUI frontend for Windows.
* [TablePro](https://github.com/TableProApp/TablePro) ⭐ 5,784 | 🐛 76 | 🌐 Swift | 📅 2026-09-05 - Native macOS client for MySQL and many other databases with inline editing, SSH tunneling, and AI assistant. Free and open-source.
...
* [LibreDB Studio](https://github.com/libredb/libredb-studio) ⭐ 405 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-05 - Browser-based SQL IDE for MySQL and nine other engines, deployed as a container or Helm chart next to the database.
...
* [replication-manager](https://github.com/signal18/replication-manager) ⭐ 739 | 🐛 186 | 🌐 Go | 📅 2026-09-05 - a high availability solution to manage MariaDB 10.x and MySQL & Percona Server 5.7 GTID replication topologies.
...
* [ProxySQL](https://github.com/sysown/proxysql) ⭐ 6,912 | 🐛 1,077 | 🌐 C++ | 📅 2026-09-05 - High performance proxy for MySQL.
...
* [TiDB](https://github.com/pingcap/tidb) ⭐ 40,490 | 🐛 6,931 | 🌐 Go | 📅 2026-09-05 - A distributed HTAP database compatible with the MySQL protocol.
* [MySQL Server & MySQL Cluster](https://github.com/mysql/mysql-server) ⭐ 12,418 | 🐛 43 | 🌐 C++ | 📅 2026-09-02 - Official Oracle's MySQL server & MySQL Cluster distribution.
* [MariaDB](https://github.com/MariaDB/server) ⭐ 8,182 | 🐛 478 | 🌐 C++ | 📅 2026-09-05 - Community developed fork of MySQL server.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 21,295 | 🐛 1,100 | 🌐 Go | 📅 2026-09-05 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [sql-splitter](https://github.com/HelgeSverre/sql-splitter) ⭐ 15 | 🐛 2 | 🌐 Rust | 📅 2026-09-02 - High-performance CLI for splitting, merging, converting, validating, and sampling mysqldump files.
...
* [VillageSQL](https://github.com/villagesql/villagesql-server) ⭐ 179 | 🐛 274 | 🌐 C++ | 📅 2026-09-05 - A drop-in replacement for MySQL with extensions for the agentic AI era.
